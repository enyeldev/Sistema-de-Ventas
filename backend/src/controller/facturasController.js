...
import { existeCodigoFactura, existeCodigoFacturaDeduda } from "../helpers/verificarCodigos.js";
...
export const imprimirFacturaVenta = async (req, res) => {
    ...
    try {
        ...
        const nuevoArregloProductos = productosDeLaVenta.map(producto => {
            ...
            const { codigoProducto, cantidadProducto, costoVentaItem, nombreProducto } = producto

            return {
                codigoProducto: codigoProducto,
                cantidadProducto: cantidadProducto,
                costoVentaItem: parseFloat(costoVentaItem),
                nombre: nombreProducto,
                totalVentaItem: parseFloat(cantidadProducto * costoVentaItem)
            }
...
export const imprimirFacturaDeuda = async (req, res) => {
    ...
    try {
        ...
        let historialDePagos = await prisma.$queryRaw`SELECT * FROM HistorialPagosDeudas WHERE codigoDedua = ${codigoDeuda}`
