/*
  ...
  - Added the required column `costoVentaItem` to the `VentasItem` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_VentasItem" ("cantidadProducto", "codigoProducto", "codigoVenta", "id") SELECT "cantidadProducto", "codigoProducto", "codigoVenta", "id" FROM "VentasItem";
