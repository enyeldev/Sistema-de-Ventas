/*
  ...
  - Added the required column `nombreProducto` to the `VentasItem` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_VentasItem" ("cantidadProducto", "codigoProducto", "codigoVenta", "costoActualProducto", "costoVentaItem", "id") SELECT "cantidadProducto", "codigoProducto", "codigoVenta", "costoActualProducto", "costoVentaItem", "id" FROM "VentasItem";
