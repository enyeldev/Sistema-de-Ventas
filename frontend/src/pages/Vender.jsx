...
import { generarNuevaVenta, generarVentasItems } from '../helpers/ventasFunciones'
...
import { generarFacturaVenta, imprimirFacturaVenta } from '../helpers/facturasFunciones'
...
export const Vender = () => {
    ...
    const cobrarVenta = async (e) => {
        ...
        if (arrProductosVent.length == 0 || pagoCliente == 0 || pagoCliente < totalVenta) {
        ...
        // const hayFinanciados = arrProductosVent.some(e => e.financiado == true)

        // if (hayFinanciados) {
        //     const arrProductosVentFinanciados = arrProductos.filter(e => e.financiado == true)

        //     console.log(arrProductosVentFinanciados);
        //     return
        // }

        // Generar nueva venta
        const codigoVenta = await generarNuevaVenta({ totalVenta, pagoCliente, devueltaCliente, auth, nombreCliente, telefonoCliente, atendidoPor })
    ...
    return (
        ...
        <div className="w-[85%] max-h-screen  bg-gray-100 rounded-md">
            <div className="flex relative p-2 gap-2 h-full">
                ...
                {showModalFacturaVenta && <ModalFacturaVenta showModalFacturaVenta={showModalFacturaVenta} setShowModalFacturaVenta={setShowModalFacturaVenta} datosFacturaVenta={datosFacturaVenta} />}
