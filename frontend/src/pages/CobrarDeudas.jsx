    ...
    return (
        <div className="w-[85%] max-h-screen bg-gray-100 rounded-md p-2">
            <div className="w-full h-full flex flex-col gap-2">
                {
                    modalDeuda.show && <ModalCobrarDeuda
                        modal={modalDeuda}
                ...
                <div className="w-full bg-white rounded-md shadow-md p-2">
                    <div className="w-full max-h-[20%]">
                        <form action="" className='flex items-end gap-3' onSubmit={buscarPorCodigo ? buscarDeudaPorCodigo : bucarDeudaPorNombre}>
                            <div className="flex flex-col gap-2 w-[50%]">
                                <Heading htmlFor="codigo" fontSize={'large'}>{buscarPorCodigo ? 'Codigo de la factura' : 'Nombre del cliente'}</Heading>
                                <Input
