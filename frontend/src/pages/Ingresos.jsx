...
export const Ingresos = () => {
  ...
  const generarIngreso = async (e) => {
    ...
    if (
      montoIngreso == "" ||
      !regexMontoValidation ||
      parseFloat(montoIngreso) <= 0
    ) {
      setErrorInput(true);
      return;
    }
  ...
  return (
    <div className="w-[85%] max-h-screen bg-gray-100 rounded-md p-2 flex items-center">
      <div className="bg-white mx-auto p-2 rounded-md shadow-lg flex flex-col gap-3">
        <div className="">
          <Heading fontSize={"x-large"}>Detalles del Ingreso</Heading>
        </div>
        ...
        <form className="flex flex-col gap-2" onSubmit={generarIngreso}>
          <div className="flex gap-2">
            ...
            <div className="flex flex-col gap-2">
              <Heading fontSize={"larger"}>Tipo de Ingreso</Heading>
            ...
            <div className="flex flex-col gap-2">
              <Heading fontSize={"larger"}>Descripcion de Ingreso</Heading>
